...
namespace InsuranceBrokerSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260428181632_AddAuthenticationEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InsuranceBrokerSystem.Domain.Entities.MasterTable.Bank", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InsuranceBrokerSystem.Domain.Entities.MasterTable.Position", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InsuranceBrokerSystem.Domain.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InsuranceBrokerSystem.Domain.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InsuranceBrokerSystem.Domain.Entities.UserRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InsuranceBrokerSystem.Domain.Entities.Clients.ClientBankAccount", b =>
                {
                    b.HasOne("InsuranceBrokerSystem.Domain.Entities.MasterTable.Bank", "Bank")
            ...
            modelBuilder.Entity("InsuranceBrokerSystem.Domain.Entities.Clients.ClientContact", b =>
                {
                    ...
                    b.HasOne("InsuranceBrokerSystem.Domain.Entities.MasterTable.Position", "Position")
            ...
            modelBuilder.Entity("InsuranceBrokerSystem.Domain.Entities.UserRole", b =>
                {
                    b.HasOne("InsuranceBrokerSystem.Domain.Entities.Role", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InsuranceBrokerSystem.Domain.Entities.User", "User")
                        .WithMany("UserRoles")
